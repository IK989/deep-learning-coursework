...
class Conv(BaseLayer):
    def __init__(self, stride_shape, convolution_shape, num_kernels):
        ...
        # num of filters or feature detectors in this layer
    ...
    def forward(self, input_tensor):
        ...
        batch_size = input_tensor.shape[0] #num of images passed simultaneously
        input_depth = input_tensor.shape[1]  # channels
